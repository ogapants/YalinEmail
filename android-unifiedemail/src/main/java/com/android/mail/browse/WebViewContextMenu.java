...
public class WebViewContextMenu implements OnCreateContextMenuListener,
    ...
    /**
     * Used to setup the image menu group if the {@link WebView.HitTestResult}
     * is of type {@link WebView.HitTestResult#IMAGE_TYPE} or
     * {@link WebView.HitTestResult#SRC_IMAGE_ANCHOR_TYPE}.
     * @param url Url that was long pressed.
     * @param menu The {@link ContextMenu} that is about to be shown.
     */
