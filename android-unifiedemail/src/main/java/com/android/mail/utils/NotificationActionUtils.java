...
public class NotificationActionUtils {
     ...
     * ({@link Notification.Builder#setWhen(long)}) is stored here so we can use it for
     ...
     * @param when The value passed into {@link Notification.Builder#setWhen(long)}.
    ...
    public static class NotificationAction implements Parcelable {
        ...
        public static final ClassLoaderCreator<NotificationAction> CREATOR =
                new ClassLoaderCreator<NotificationAction>() {
                    @Override
