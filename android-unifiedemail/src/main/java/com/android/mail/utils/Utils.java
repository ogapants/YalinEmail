...
public class Utils {
    ...
    * @see {@link Intent#setType}
    * @see {@link Intent#setTypeAndNormalize}
    */
   ...
   /**
    * (copied from {@link Uri#normalizeScheme()} for pre-J)
    *
   ...
   public static int getTransparentColor(int color) {
     ...
     *
     * @param uri
     * @return a valid URI, possibly {@link Uri#EMPTY}
     */
    ...
    Address getAddress(Map<String, Address> cache, String emailStr) {
        Address addr;
        synchronized (cache) {
