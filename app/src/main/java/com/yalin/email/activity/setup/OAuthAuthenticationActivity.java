package com.yalin.email.activity.setup;
...
import com.yalin.email.mail.internet.OAuthAuthenticator;
...
public class OAuthAuthenticationActivity extends Activity implements
        LoaderCallbacks<OAuthAuthenticator.AuthenticationResult> {
    ...
    private static class OAuthTokenLoader extends MailAsyncTaskLoader<OAuthAuthenticator.AuthenticationResult> {
        ...
        @Override
        protected void onDiscardResult(OAuthAuthenticator.AuthenticationResult result) {
        ...
        public OAuthAuthenticator.AuthenticationResult loadInBackground() {
            try {
                ...
                final OAuthAuthenticator.AuthenticationResult result = authenticator.requestAccess(
    ...
    @Override
    public Loader<OAuthAuthenticator.AuthenticationResult> onCreateLoader(int id, Bundle data) {
    ...
    @Override
    public void onLoadFinished(Loader<OAuthAuthenticator.AuthenticationResult> loader,
        OAuthAuthenticator.AuthenticationResult data) {
        if (data == null) {
