...
public class EmailBroadcastProcessorService extends IntentService {
    ...
    /**
     * Entry point for {@link SecurityPolicy.PolicyAdmin}.  These will
     * simply callback to {@link
     * SecurityPolicy#onDeviceAdminReceiverMessage(Context, int)}.
     */
