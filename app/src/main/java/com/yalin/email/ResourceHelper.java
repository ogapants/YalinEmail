...
public class ResourceHelper {
    ...
    private ResourceHelper(Context context) {
        ...
        mAccountColorArray = mResources.obtainTypedArray(com.yalin.email.R.array.combined_view_account_colors);
        mAccountColors = mResources.getIntArray(com.yalin.email.R.array.combined_view_account_colors);
